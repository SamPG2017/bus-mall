...
function clickHandler(event) {
  ...
  for (var i in Product.allProducts) {
    console.log('checking for product to add to click total ...');
    if (event.target.alt === Product.allProducts[i].imgname) {
      console.log('found product, before adding click total: ' + Product.allProducts[i].numClicked);
      // once we find the one that matches, increment counter on 
      // that specific object
      Product.allProducts[i].numClicked++;
      console.log('afer adding click: ' + Product.allProducts[i].numClicked);
    }
